    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((authorize) -> authorize
                        .requestMatchers(
                                "/css/**","/imagen/**","/bootstrap/**","/iconos/**","/imagen/**","/tema/**","/tema/miestilo.css",
                                "/favicon.ico","/process_register",
                                "/index",
                                "/inicio",
                                "/eShop",
                                "/login",
                        ...
                        .requestMatchers("/agregarAlCarrito/**", "/carrito", "/eliminarDelCarrito/**").authenticated()
                        .anyRequest().authenticated()
                )
                // Comentamos o eliminamos formLogin si manejamos la autenticación en el controlador
